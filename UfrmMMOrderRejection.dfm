object frmMMOrderRejection: TfrmMMOrderRejection
  Left = 342
  Top = 166
  Caption = 'Order Rejection'
  ClientHeight = 360
  ClientWidth = 565
  Color = clBtnFace
...
Transparent = True
    ...
    object AdvPanel3: TAdvPanel
      ...
      Caption.Indent = 2
      Caption.ShadeLight = 255
      Caption.Text = '<FONT face="Arial"><B>Rejection Details</B></FONT>'
      Caption.Visible = True
      CollapsColor = clNone
      CollapsDelay = 0
      ColorTo = 15784647
    ...
    object txtRejectionComment: TcxTextEdit
      Left = 90
      Top = 55
      ParentFont = False
    ...
    object lkpRejectionReasonType: TcxLookupComboBox
      Left = 90
      Top = 27
