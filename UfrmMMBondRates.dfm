object frmMMBondRates: TfrmMMBondRates
  Left = 457
  Top = 171
  Caption = 'Bond Rates'
  ClientHeight = 462
  ...
  object AdvPanel2: TAdvPanel
    ...
    Caption.Text = '<FONT face="Arial"><B>Yield Rates</B></FONT>'
  ...
  object cvPanel2: TPanel
    ...
    object AdvPanel1: TAdvPanel
      ...
      Caption.Indent = 2
      Caption.ShadeLight = 255
      Caption.Text = '<FONT face="Arial"><B>Bond Period</B></FONT>'
      Caption.Visible = True
      CollapsColor = clNone
      CollapsDelay = 0
      ColorTo = 15784647
  ...
  object spMMBondNameList: TADOStoredProc
    Connection = dtmMain.cnnMain
    CursorType = ctStatic
    CommandTimeout = 300
    ProcedureName = 'spMMBondNameList;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 417
    Top = 186
    object spMMBondNameListID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object spMMBondNameListName: TStringField
      FieldName = 'Name'
      Size = 200
    end
    object spMMBondNameListShortName: TStringField
      FieldName = 'ShortName'
      Size = 50
    end
    object spMMBondNameListIssuer: TStringField
      FieldName = 'Issuer'
      Size = 200
    end
    object spMMBondNameListBondType: TIntegerField
      FieldName = 'BondType'
    end
    object spMMBondNameListCouponAccrualType: TIntegerField
      FieldName = 'CouponAccrualType'
    end
    object spMMBondNameListCouponRate: TFloatField
      FieldName = 'CouponRate'
      DisplayFormat = ',#0.00'
    end
    object spMMBondNameListCouponPeriodType: TIntegerField
      FieldName = 'CouponPeriodType'
    end
    object spMMBondNameListCouponPeriodLength: TIntegerField
      FieldName = 'CouponPeriodLength'
    end
    object spMMBondNameListShortFirstCouponPeriod: TBooleanField
      FieldName = 'ShortFirstCouponPeriod'
    end
    object spMMBondNameListCouponPaymentPeriod: TIntegerField
      FieldName = 'CouponPaymentPeriod'
    end
    object spMMBondNameListValue: TFloatField
      FieldName = 'Value'
      DisplayFormat = ',#0.00'
    end
    object spMMBondNameListCurrencyID: TIntegerField
      FieldName = 'CurrencyID'
    end
    object spMMBondNameListIssuedUnits: TIntegerField
      FieldName = 'IssuedUnits'
    end
    object spMMBondNameListTradeUnits: TIntegerField
      FieldName = 'TradeUnits'
    end
    object spMMBondNameListValueDate: TDateTimeField
      FieldName = 'ValueDate'
    end
    object spMMBondNameListMaturityDate: TDateTimeField
      FieldName = 'MaturityDate'
    end
    object spMMBondNameListTenor: TIntegerField
      FieldName = 'Tenor'
    end
    object spMMBondNameListPrescribed: TBooleanField
      FieldName = 'Prescribed'
    end
    object spMMBondNameListMatured: TBooleanField
      FieldName = 'Matured'
    end
    object spMMBondNameListActive: TBooleanField
      FieldName = 'Active'
    end
    object spMMBondNameListUsername: TStringField
      FieldName = 'Username'
      Size = 100
    end
    object spMMBondNameListUserID: TIntegerField
      FieldName = 'UserID'
    end
    object spMMBondNameListCreationDate: TDateTimeField
      FieldName = 'CreationDate'
    end
  end
  object spMMBondRateUpdate: TADOStoredProc
    Connection = dtmMain.cnnMain
    CursorType = ctStatic
    ProcedureName = 'spMMBondRateUpdate;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object spMMBondRateLoad: TADOStoredProc
    Connection = dtmMain.cnnMain
    CursorType = ctStatic
    ProcedureName = 'spMMBondRateLoad;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 388
    Top = 186
    object spMMBondRateLoadBondID: TIntegerField
      FieldName = 'BondID'
      ReadOnly = True
    end
    object spMMBondRateLoadDate: TDateTimeField
      FieldName = 'Date'
      ReadOnly = True
    end
    object spMMBondRateLoadRate: TFloatField
      FieldName = 'Rate'
      ReadOnly = True
      DisplayFormat = ',#0.00'
    end
