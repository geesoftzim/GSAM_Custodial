object frmTransferSecretary: TfrmTransferSecretary
  Left = 280
  Top = 120
  ...
  object pgeClientDetails: TcxPageControl
    ...
    object tshClient: TcxTabSheet
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      Caption = 'Transfer Secretary Details'
      ExplicitTop = 34
      ExplicitWidth = 837
      ExplicitHeight = 467
  ...
  object spTransferSecretaryCreateEx: TADOStoredProc
    Connection = dtmMain.cnnMain
    ProcedureName = 'spTransferSecretaryCreateEx;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object spTransferSecretaryView: TADOStoredProc
    Connection = dtmMain.cnnMain
    EnableBCD = False
    ProcedureName = 'spTransferSecretaryView;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 282
    Top = 302
    object spTransferSecretaryViewID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object spTransferSecretaryViewName: TStringField
      FieldName = 'Name'
      Size = 200
    end
    object spTransferSecretaryViewPhysicalAddress: TStringField
      FieldName = 'PhysicalAddress'
      Size = 50
    end
    object spTransferSecretaryViewPhysicalAddress2: TStringField
      FieldName = 'PhysicalAddress2'
      Size = 50
    end
    object spTransferSecretaryViewPhysicalAddress3: TStringField
      FieldName = 'PhysicalAddress3'
      Size = 50
    end
    object spTransferSecretaryViewPhysicalCity: TIntegerField
      FieldName = 'PhysicalCity'
    end
    object spTransferSecretaryViewPhysicalCountry: TIntegerField
      FieldName = 'PhysicalCountry'
    end
    object spTransferSecretaryViewPostalAddress: TStringField
      FieldName = 'PostalAddress'
      Size = 50
    end
    object spTransferSecretaryViewPostalAddress2: TStringField
      FieldName = 'PostalAddress2'
      Size = 50
    end
    object spTransferSecretaryViewPostalAddress3: TStringField
      FieldName = 'PostalAddress3'
      Size = 50
    end
    object spTransferSecretaryViewPostalCity: TIntegerField
      FieldName = 'PostalCity'
    end
    object spTransferSecretaryViewPostalCountry: TIntegerField
      FieldName = 'PostalCountry'
    end
    object spTransferSecretaryViewPhoneNo: TStringField
      FieldName = 'PhoneNo'
      Size = 50
    end
    object spTransferSecretaryViewPhoneNo2: TStringField
      FieldName = 'PhoneNo2'
      Size = 50
    end
    object spTransferSecretaryViewFaxNo: TStringField
      FieldName = 'FaxNo'
      Size = 50
    end
    object spTransferSecretaryViewEmailAddress: TStringField
      FieldName = 'EmailAddress'
      Size = 50
    end
    object spTransferSecretaryViewPhoneNo3: TStringField
      FieldName = 'PhoneNo3'
      Size = 200
    end
    object spTransferSecretaryViewClientNo: TStringField
      FieldName = 'ClientNo'
      Size = 200
    end
    object spTransferSecretaryViewLicenceNo: TStringField
      FieldName = 'LicenceNo'
      Size = 200
    end
    object spTransferSecretaryViewVATRegistrationNo: TStringField
      FieldName = 'VATRegistrationNo'
      Size = 200
    end
    object spTransferSecretaryViewActive: TBooleanField
      FieldName = 'Active'
    end
    object spTransferSecretaryViewUsername: TStringField
      FieldName = 'Username'
      Size = 200
    end
  end
