object frmMMBondList: TfrmMMBondList
 ...
 OptionsData.Inserting = False
        ...
        object jvCoupon: TJvTimeLine
          ...
          YearFont.Color = 4117503
          YearFont.Height = -37
          YearFont.Name = 'Arial'
          YearFont.Style = [fsBold]
          YearWidth = 400
          ShowMonthNames = True
          FirstVisibleDate = 40360.000000000000000000
          Items = <>
          ItemHeight = 24
          VertSupports = True
          HorzSupports = True
          OnItemClick = jvCouponItemClick
          DesignSize = (
            539
            215)
        end
 ...
 OptionsData.Inserting = False
  ...
  object spMMBondAllocationList: TADOStoredProc
    ...
    object spMMBondAllocationListPaymentReferenceNo: TIntegerField
