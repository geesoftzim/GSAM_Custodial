object frmUserList: TfrmUserList
      ...
      object RzPanel2: TRzPanel
        ...
        object grdPermissionsMain: TcxGrid
          ...
          object grdPermissions: TcxGridDBBandedTableView
            Navigator.Buttons.CustomButtons = <>
            DataController.DataSource = dsUserRoleList
            DataController.KeyFieldNames = 'ID'
            DataController.Summary.DefaultGroupSummaryItems = <>
            DataController.Summary.FooterSummaryItems = <>
            DataController.Summary.SummaryGroups = <>
  ...
  object aclToolbar: TActionList
    ...
    object actDeactivate: TAction
      Caption = 'Deactivate'
      OnExecute = actDeactivateExecute
      OnUpdate = actDeactivateUpdate
    end
  end
  object pmnuActions: TAdvPopupMenu
    ...
    object OpenUserManager1: TMenuItem
      Caption = 'Open User Group Manager'
    ...
    object mnuActivate: TMenuItem
      Action = actActivate
    end
    object mnuDeactivate: TMenuItem
  ...
  object spUserList: TADOStoredProc
    ...
    CursorType = ctStatic
    AfterScroll = spUserListAfterScroll
