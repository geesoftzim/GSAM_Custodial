...
uses
  ...
  Dialogs, ComCtrls, QuickRpt, QRCtrls, DB, ExtCtrls, ADODB, DateUtils, grimgctrl,
...
type
  TfrmUTQuickReports = class(TForm)
    ...
    QRLabel266: TQRLabel;
    QRExpr83: TQRExpr;
    spRptUTClientListLastTrxDateSel: TStringField;
    QRLabel101: TQRLabel;
    QRDBText111: TQRDBText;
    QRDBText112: TQRDBText;
    QRLabel102: TQRLabel;
    spRptFeeComputationStartDate: TDateTimeField;
    spRptFeeComputationEndDate: TDateTimeField;
    QRLabel103: TQRLabel;
    QRLabel104: TQRLabel;
    ...
    spRptConsolidated: TADOStoredProc;
    ...
    spRptConsolidatedID: TLargeintField;
    spRptConsolidatedvxType: TStringField;
    spRptConsolidatedClientNo: TStringField;
    spRptConsolidatedAccountName: TStringField;
    spRptConsolidatedPostalAddress: TStringField;
    spRptConsolidatedPostalAddress2: TStringField;
    spRptConsolidatedPostalAddress3: TStringField;
    spRptConsolidatedCityName: TStringField;
    spRptConsolidatedCountryName: TStringField;
    spRptConsolidatedStartDate: TDateTimeField;
    spRptConsolidatedEndDate: TDateTimeField;
    spRptConsolidatedValue1: TDateTimeField;
    spRptConsolidatedValue2: TStringField;
    spRptConsolidatedValue3: TStringField;
    spRptConsolidatedValue4: TFloatField;
    spRptConsolidatedValue5: TFloatField;
    spRptConsolidatedValue6: TFloatField;
    spRptConsolidatedValue7: TFloatField;
    spRptConsolidatedValue8: TFloatField;
    spRptConsolidatedValue9: TFloatField;
    spRptConsolidatedValue10: TFloatField;
    spRptConsolidatedValue11: TStringField;
    spRptConsolidatedValue12: TStringField;
    spRptConsolidatedLabel1: TStringField;
    spRptConsolidatedLabel2: TStringField;
    spRptConsolidatedLabel3: TStringField;
    spRptConsolidatedLabel4: TStringField;
    spRptConsolidatedLabel5: TStringField;
    spRptConsolidatedLabel6: TStringField;
    spRptConsolidatedLabel7: TStringField;
    spRptConsolidatedLabel8: TStringField;
    spRptConsolidatedLabel9: TStringField;
    spRptConsolidatedLabel10: TStringField;
    spRptConsolidatedLabel11: TStringField;
    spRptConsolidatedLabel12: TStringField;
    spRptConsolidatedStatementComment: TStringField;
    spRptConsolidatedOrder: TIntegerField;
    spRptConsolidatedBalanceBroughForwardActual: TFloatField;
    spRptConsolidatedType: TStringField;
    ...
    QRExpr28: TQRExpr;
    QRExpr29: TQRExpr;
    spRptConsolidatedActualBalance: TFloatField;
    QRExpr30: TQRExpr;
    ...
    QRExpr114: TQRExpr;
    QRExpr115: TQRExpr;
    spRptConsolidatedAccountID: TLargeintField;
    spRptConsolidatedSortOrder: TStringField;
    spRptUnitStatementAccountCurrency: TStringField;
    QRLabel113: TQRLabel;
    QRDBText153: TQRDBText;
    QRLabel270: TQRLabel;
    QRDBText154: TQRDBText;
    spRptUnitDealsDateLabel: TStringField;
    spRptUnitDealsConfirmedTotalSubtotal: TFloatField;
    spRptUnitDealsUnconfirmedTotalSubTotal: TFloatField;
    spRptUnitDealsConfirmedTotalAmount: TFloatField;
    spRptUnitDealsUnconfirmedTotalAmount: TFloatField;
    QRLabel114: TQRLabel;
    ...
    spRptUTPaymentsSchedule: TADOStoredProc;
    spRptUTPaymentsScheduleLongName: TStringField;
    spRptUTPaymentsScheduleClientAccountNo: TStringField;
    spRptUTPaymentsScheduleUTFundAccountNo: TStringField;
    spRptUTPaymentsScheduleFundName: TStringField;
    spRptUTPaymentsSchedulePaymentType: TStringField;
    spRptUTPaymentsScheduleAmount: TFloatField;
    spRptUTPaymentsScheduleValueDate: TDateTimeField;
    spUTFiscalTaxInvoice: TADOStoredProc;
    spUTFiscalTaxInvoiceID: TLargeintField;
    spUTFiscalTaxInvoiceInviceNo: TStringField;
    spUTFiscalTaxInvoiceUnitTrustID: TLargeintField;
    spUTFiscalTaxInvoiceDate: TDateTimeField;
    spUTFiscalTaxInvoicePercentage: TFMTBCDField;
    spUTFiscalTaxInvoiceFee: TFMTBCDField;
    spUTFiscalTaxInvoiceServiceFees: TFMTBCDField;
    spUTFiscalTaxInvoiceVatAmountFee: TFMTBCDField;
    spUTFiscalTaxInvoiceTotalFees: TFMTBCDField;
    TabSheet18: TTabSheet;
    QRUTFiscalTaxInvoice: TQRPQuickrep;
    QRBand248: TQRBand;
    ...
    QRLabel131: TQRLabel;
    spRptUTPaymentsScheduleBankName: TStringField;
    spRptUTPaymentsScheduleBankBranchName: TStringField;
    spRptUTPaymentsScheduleBankBranchNo: TStringField;
    spRptUTPaymentsScheduleUsername: TWideStringField;
    QRLabel132: TQRLabel;
    ...
    procedure QRConsolidatedAfterPrint(Sender: TObject);
  private
...
procedure TfrmUTQuickReports.QRConsolidatedAfterPrint(Sender: TObject);
begin
    if dtmMain.ChargeStatement then
    begin
        with spStatementPrintCharge do
        begin
            Parameters.ParamByName('@AccountID').Value := spRptConsolidatedAccountID.Value;
            Parameters.ParamByName('@ValueDate').Value := DateOf(Today);
            Prepared := True;
            ExecProc;
        end;
