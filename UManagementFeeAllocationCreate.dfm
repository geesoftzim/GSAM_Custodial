object frmManagementFeeAllocationCreate: TfrmManagementFeeAllocationCreate
  Left = 0
  Top = 0
  Caption = 'Management Fee Allocation'
  ClientHeight = 358
  ClientWidth = 513
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object AdvPanel2: TAdvPanel
      ...
      Caption.Text = '<FONT face="Arial"><B>Fee Schedule Details</B></FONT>'
    ...
    object cxDBTextEdit4: TcxDBTextEdit
      ...
      DataBinding.DataSource = dsManagementFeeScheduleView
      Enabled = False
      ParentFont = False
  ...
  object dsManagementFeeScheduleView: TDataSource
    DataSet = spManagementFeeScheduleView
    Left = 392
    Top = 32
  end
  object spManagementFeeScheduleView: TADOStoredProc
    Connection = dtmMain.cnnMain
    CursorType = ctStatic
    ProcedureName = 'spManagementFeeScheduleView;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 400
    Top = 88
    object spManagementFeeScheduleViewID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object spManagementFeeScheduleViewAssetManagerID: TIntegerField
      FieldName = 'AssetManagerID'
    end
    object spManagementFeeScheduleViewCreationDate: TDateTimeField
      FieldName = 'CreationDate'
    end
    object spManagementFeeScheduleViewValueDate: TDateTimeField
      FieldName = 'ValueDate'
    end
    object spManagementFeeScheduleViewUserName: TStringField
      FieldName = 'UserName'
      Size = 50
    end
    object spManagementFeeScheduleViewConfirmed: TBooleanField
      FieldName = 'Confirmed'
    end
    object spManagementFeeScheduleViewConfirmedUserName: TStringField
      FieldName = 'ConfirmedUserName'
      Size = 50
    end
    object spManagementFeeScheduleViewConfirmedDate: TDateTimeField
      FieldName = 'ConfirmedDate'
    end
    object spManagementFeeScheduleViewRejected: TBooleanField
      FieldName = 'Rejected'
    end
    object spManagementFeeScheduleViewRejectedUserName: TStringField
      FieldName = 'RejectedUserName'
      Size = 50
    end
    object spManagementFeeScheduleViewRejectedDate: TDateTimeField
      FieldName = 'RejectedDate'
    end
    object spManagementFeeScheduleViewTotalAmount: TFMTBCDField
      FieldName = 'TotalAmount'
      Precision = 38
      Size = 2
    end
    object spManagementFeeScheduleViewAssetManagerName: TStringField
      FieldName = 'AssetManagerName'
      Size = 50
    end
    object spManagementFeeScheduleViewStatus: TIntegerField
      FieldName = 'Status'
      ReadOnly = True
    end
  end
  object cmdManagementFeeAllocationCreate: TADOCommand
    CommandText = 'spManagementFeeAllocationCreate;1'
