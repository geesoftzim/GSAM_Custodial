object frmMMJournal: TfrmMMJournal
  ...
  object pgeJournals: TcxPageControl
    ...
    object tshJounalList: TcxTabSheet
      ...
      object insTransactions: TcxDBVerticalGrid
        ...
        Height = 508
        Align = alRight
        OptionsView.RowHeaderWidth = 105
  ...
  object spMMJournalTransactions: TADOStoredProc
    Connection = dtmMain.cnnMain
    CursorType = ctStatic
    CommandTimeout = 600
    EnableBCD = False
    ProcedureName = 'spMMJournalTransactions;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 393
    Top = 222
    object spMMJournalTransactionsID: TLargeintField
      FieldName = 'ID'
    end
    object spMMJournalTransactionsDate: TDateTimeField
      FieldName = 'Date'
    end
    object spMMJournalTransactionsTransactionType: TIntegerField
      FieldName = 'TransactionType'
    end
    object spMMJournalTransactionsTransctionTypeName: TStringField
      FieldName = 'TransactionTypeName'
      Size = 50
    end
    object spMMJournalTransactionsAmount: TFloatField
      FieldName = 'Amount'
      DisplayFormat = ',#0.00'
    end
    object spMMJournalTransactionsCreditAmount: TFloatField
      FieldName = 'CreditAmount'
      DisplayFormat = ',#0.00'
    end
    object spMMJournalTransactionsDebitAmount: TFloatField
      FieldName = 'DebitAmount'
      DisplayFormat = ',#0.00'
    end
    object spMMJournalTransactionsLongName: TStringField
      FieldName = 'LongName'
      Size = 300
    end
    object spMMJournalTransactionsSearchName: TStringField
      FieldName = 'SearchName'
      Size = 200
    end
    object spMMJournalTransactionsAccountID: TLargeintField
      FieldName = 'AccountID'
    end
    object spMMJournalTransactionsAccountNo: TStringField
      FieldName = 'AccountNo'
      Size = 50
    end
    object spMMJournalTransactionsBalancingAccountID: TLargeintField
      FieldName = 'BalancingAccountID'
    end
    object spMMJournalTransactionsLongAccountNo: TStringField
      FieldName = 'LongAccountNo'
      Size = 300
    end
    object spMMJournalTransactionsUserID: TIntegerField
      FieldName = 'UserID'
    end
    object spMMJournalTransactionsUserName: TStringField
      FieldName = 'UserName'
      Size = 128
    end
    object spMMJournalTransactionsConfirmed: TBooleanField
      FieldName = 'Confirmed'
    end
    object spMMJournalTransactionsRejected: TBooleanField
      FieldName = 'Rejected'
    end
    object spMMJournalTransactionsPaymentType: TIntegerField
      FieldName = 'PaymentType'
    end
    object spMMJournalTransactionsPaymentTypeName: TStringField
      FieldName = 'PaymentTypeName'
      Size = 50
    end
    object spMMJournalTransactionsValueDate: TDateTimeField
      FieldName = 'ValueDate'
    end
    object spMMJournalTransactionsStatus: TIntegerField
      FieldName = 'Status'
    end
    object spMMJournalTransactionsReferenceTransactionID: TLargeintField
      FieldName = 'ReferenceTransactionID'
    end
    object spMMJournalTransactionsAccountTypeName: TStringField
      FieldName = 'AccountTypeName'
      Size = 100
    end
    object spMMJournalTransactionsCurrencyCode: TStringField
  ...
  object dsEQJournalTransactions: TDataSource
    AutoEdit = False
    DataSet = spMMJournalTransactions
    Left = 391
    Top = 252
  end
