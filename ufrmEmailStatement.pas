...
type
  TfrmEmailStatement = class(TForm)
    ...
    cxLabel7: TcxLabel;
    cboSSLVersion: TcxComboBox;
    cxLabel8: TcxLabel;
    cboSSLMethod: TcxComboBox;
    Button1: TButton;
...
//    dtmMain.SetNumericParameter('SSL Version', cboSSLVersion.ItemIndex);
//    dtmMain.SetNumericParameter('SSL Method', cboSSLMethod.ItemIndex);
    ...
    begin
        ...
        //send report
            dtmMain.EmailReport(QRReport,
                ...
                dtmMain.StringParameter('SMTP Password'));
            Close;
...
procedure TfrmEmailStatement.Button1Click(Sender: TObject);
begin
    OpenDialog1.Execute;
...
begin
    ...
    cboSSLVersion.ItemIndex := Round(dtmmain.NumericParameter('SSL Version'));
    cboSSLMethod.ItemIndex := Round(dtmmain.NumericParameter('SSL Method'));
end;
