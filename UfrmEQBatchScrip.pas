...
uses
  ...
  dxSkinsdxBarPainter, dxSkinsCore, dxSkinsDefaultPainters, dxSkinBlueprint,
  ...
  dxSkinSpringTime, dxSkinStardust, dxSkinSummer2008, dxSkinXmas2008Blue;

type
  TfrmEQBatchScrip = class(TForm)
    ...
    grdCorpActionMain: TcxGrid;
    grdCorpAction: TcxGridDBBandedTableView;
    grdCorpActionLevel: TcxGridLevel;
    grdCorpActionID: TcxGridDBBandedColumn;
    grdCorpActionScripCategoryID: TcxGridDBBandedColumn;
    grdCorpActionScripCategoryName: TcxGridDBBandedColumn;
    grdCorpActionBatchID: TcxGridDBBandedColumn;
    grdCorpActionTransferSecretaryID: TcxGridDBBandedColumn;
    grdCorpActionTransferSecretary: TcxGridDBBandedColumn;
    grdCorpActionRecievedDate: TcxGridDBBandedColumn;
    grdCorpActionCertificateNo: TcxGridDBBandedColumn;
    grdCorpActionCounterpartyID: TcxGridDBBandedColumn;
    grdCorpActionRegisteredHolder: TcxGridDBBandedColumn;
    grdCorpActionRegistrationDate: TcxGridDBBandedColumn;
    grdCorpActionCounterID: TcxGridDBBandedColumn;
    grdCorpActionCounterName: TcxGridDBBandedColumn;
    grdCorpActionQuantity: TcxGridDBBandedColumn;
    grdCorpActionBalance: TcxGridDBBandedColumn;
    grdCorpActionDeliveryDate: TcxGridDBBandedColumn;
    grdCorpActionDeliveredTo: TcxGridDBBandedColumn;
    grdCorpActionLocationID: TcxGridDBBandedColumn;
    grdCorpActionLocationName: TcxGridDBBandedColumn;
    grdCorpActionCreationDate: TcxGridDBBandedColumn;
    grdCorpActionUserID: TcxGridDBBandedColumn;
    ...
    spEQAllocationDetailsDefaultScripCategory: TIntegerField;
    txtType: TcxTextEdit;
    cxLabel1: TcxLabel;
    cxLabel2: TcxLabel;
    cxDBTextEdit29: TcxDBTextEdit;
    spEQAllocationDetailsScripCategory: TStringField;
    spEQSCripCorporateActionDetailsCorporateActionID: TAutoIncField;
    spEQSCripCorporateActionDetailsDate: TDateTimeField;
    spEQSCripCorporateActionDetailsCounterID: TIntegerField;
    spEQSCripCorporateActionDetailsCounter: TStringField;
    spEQSCripCorporateActionDetailsCorporateActionType: TStringField;
    spEQSCripCorporateActionDetailsActionID: TIntegerField;
    ...
    spEQSCripCorporateActionDetailsCustodialGroup: TStringField;
    ...
    spEQUpdateCorporateActionScriped: TADOStoredProc;
    spEQGetDealScripsDealID: TIntegerField;
    spEQScripViewHolderNo: TStringField;
    cxLabel3: TcxLabel;
    edtHolderNo: TcxTextEdit;
    spEQGetBatchScripsHolderNo: TStringField;
    ...
    procedure Start(ExtBNID: Int64; ExtDealID: Int64;  ExtCorporateActionID: Int64; ExtCorporateActionType: String; ExtDirection: String);
...
var
  frmEQBatchScrip: TfrmEQBatchScrip;
...
procedure TfrmEQBatchScrip.DeleteScrip;
begin
...
procedure TfrmEQBatchScrip.DetachScrip;
begin
  if SelectedScripID <> 0 then
    begin
...
procedure TfrmEQBatchScrip.SaveScrip(IncludeDischargeDetails : Boolean);
var
  numQuantity : Integer;
...
begin
     ...
     with spEQScripCreate do
       begin
            ...
            Parameters.ParamByName('@CorporateActionType').Value := CAType;
            Parameters.ParamByName('@Direction').Value := CADirection;
            ...
            else if (IncludeDischargeDetails) and (tshCorporateAction.showing) then
              begin
                Parameters.ParamByName('@DeliveryDate').Value := Today;
                Parameters.ParamByName('@DeliveredTo').Value  := spEQSCripCorporateActionDetailsCorporateActionType.Value;
                Parameters.ParamByName('@Discharged').Value := true;
                if tblScripDischargeType.Locate('Name', 'Other', []) then
                 Parameters.ParamByName('@DischargeType').value := tblScripDischargeTypeType.Value;
              end
...
procedure TfrmEQBatchScrip.FormShow(Sender: TObject);
begin
...
procedure TfrmEQBatchScrip.lkpCounterPropertiesEditValueChanged(
  Sender: TObject);
begin
    tblShareTransferSecretary.Locate('ID', tblCounterTransferSecretaryID.Value, []);
end;

procedure TfrmEQBatchScrip.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    dtmMain.SaveGridStoredProperties(TForm(Self));

    if Assigned(frmEQScrip) then begin
        frmEQScrip.actRefreshExecute(nil);
    end;
    Action := caFree;
    frmEQBatchScrip := nil;
end;

procedure TfrmEQBatchScrip.actNewExecute(Sender: TObject);
var
    iDefault: Integer;
begin
    bInserting := True;
    ...
    begin
        ...
        lkpCategory.EditValue := spEQBatchDetailsScripCategory.Value;
    ...
    begin
        ...
        lkpCategory.EditValue := spEQAllocationDetailsDefaultScripCategory.Value;
    end else if CAID <> 0 then
    begin
        lkpCounter.EditValue := spEQSCripCorporateActionDetailsCounterID.Value;
        lkpCategory.EditValue := spEQSCripCorporateActionDetailsCategoryID.Value;
    end;
    tblShareTransferSecretary.Locate('ID', tblCounterTransferSecretaryID.Value, []);
...
procedure TfrmEQBatchScrip.actEditExecute(Sender: TObject);
begin
...
procedure TfrmEQBatchScrip.actSaveExecute(Sender: TObject);
var
    V: Integer;
    C: Integer;
begin
    ...
    if (BNID <> 0) and ((grdScrip.DataController.Summary.FooterSummaryValues[0]
        - OldQuantity
    ...
    if (DealID <> 0) and ((grdDealScrip.DataController.Summary.FooterSummaryValues[0]
        - OldQuantity
...
procedure TfrmEQBatchScrip.actCancelExecute(Sender: TObject);
begin
    actRefreshExecute(nil);
    bInserting := false;
    bEditing := false;
...
procedure TfrmEQBatchScrip.actRefreshExecute(Sender: TObject);
var
    curID: Int64;
begin
    dtmMain.EnsureDataAccess(tblCounter);
    ...
    begin
        ...
        begin
            ...
            Open;
            if spEQAllocationDetailsQuantity.Value < 0 then
                txtType.Text := 'Minus Certificate'
            else
                txtType.Text := 'Take On';
        end;
    ...
    begin
        ...
        if not spEQGetCorporateActionScripsCorporateActionID.IsNull then
            ...
            begin
                Close;
                Parameters.ParamByName('@ID').Value := CAID;
                Parameters.ParamByName('@Type').Value := CAType;
                Parameters.ParamByName('@Direction').Value := CADirection;
                Prepared := True;
                Open;
            end;
            ...
            begin
                Close;
                Parameters.ParamByName('@ActionID').Value := CAID;
                Parameters.ParamByName('@Type').Value := CAType;
                Parameters.ParamByName('@Direction').Value := CADirection;
                Prepared := True;
                Open;
...
procedure TfrmEQBatchScrip.spEQGetBatchScripsAfterScroll(DataSet: TDataSet);
begin
...
procedure TfrmEQBatchScrip.Start(
  ExtBNID: Int64;
  ExtDealID: Int64;
  ExtCorporateActionID: Int64;
  ExtCorporateActionType: String;
  ExtDirection: String);
begin
    BNID := ExtBNID;
    DealID := ExtDealID;
    CAID := ExtCorporateActionID;
    CAType := ExtCorporateActionType;
    CADirection := ExtDirection;
    ...
    if (spEQBatchDetails.Active and (spEQBatchDetailsBatchTypeName.Value = 'Sell'))
       ...
       or (spEQScripCorporateActionDetails.Active and (spEQSCripCorporateActionDetailsDirection.Value = 'Outgoing'))
    then
    begin
        if (BNID <> 0) then
            lkpCounter.EditValue := spEQBatchDetailsCounterID.Value
...
procedure TfrmEQBatchScrip.actDeleteExecute(Sender: TObject);
var
    Quantity: Integer;
begin
...
procedure TfrmEQBatchScrip.actNewUpdate(Sender: TObject);
begin
    TAction(Sender).Enabled :=
        ...
        (spEQSCripCorporateActionDetailsDirection.Value = 'Incoming'))
        );
end;

procedure TfrmEQBatchScrip.actEditUpdate(Sender: TObject);
begin
    TAction(Sender).Enabled :=
        (not bInserting) and
        (not bEditing) and
        ...
        (spEQAllocationDetailsQuantity.Value > 0))
        or
        ((spEQGetCorporateActionScrips.Active) and
        (spEQGetCorporateActionScrips.RecordCount > 0) and
        (spEQSCripCorporateActionDetailsDirection.Value = 'Incoming'))
        );
end;

procedure TfrmEQBatchScrip.actSaveUpdate(Sender: TObject);
begin
    TAction(Sender).Enabled :=
        (bInserting or bEditing) and
        (((spEQBatchDetails.Active) and (spEQBatchDetailsBatchTypeName.Value = 'Purchase')) or
         ((spEQAllocationDetails.Active) and (spEQAllocationDetailsQuantity.Value > 0)) or
         ((spEQSCripCorporateActionDetails.Active) and (spEQSCripCorporateActionDetailsDirection.Value = 'Incoming'))
        );
end;

procedure TfrmEQBatchScrip.actDeleteUpdate(Sender: TObject);
begin
    TAction(Sender).Enabled :=
        (not bInserting) and
        (not bEditing) and
...
procedure TfrmEQBatchScrip.actRefreshUpdate(Sender: TObject);
begin
    TAction(Sender).Enabled :=
        (not bInserting) and
        (not bEditing);
...
procedure TfrmEQBatchScrip.actSelectScripExecute(Sender: TObject);
var
...
begin
    ...
    if BNID <> 0 then
        ...
        fCP.SelectCandidate(SelectScrip, lkpCounter.EditValue, spEQSCripCorporateActionDetailsUnScriped.Value, spEQSCripCorporateActionDetailsCategoryID.Value, 0);
end;

procedure TfrmEQBatchScrip.SelectScrip(ScripID: Int64);
begin
...
procedure TfrmEQBatchScrip.SetEditMode(Sender: TObject);
var
    i: Integer;
begin
   with Self do begin
...
procedure TfrmEQBatchScrip.actAttachScripExecute(Sender: TObject);
begin
    bEditing := true;
    bInserting := false;

    if spEQScripViewDischarged.Value then
    begin
        MessageDlg('This script has been discharged.', mtWarning, [mbOk], 0);
        exit;
    end;
  ...
  if BNID <> 0 then
    ...
    begin
        with spEQUpdateCorporateActionScriped do
        begin
            Parameters.ParamByName('@ScripID').Value := SelectedScripID;
            Parameters.ParamByName('@OldQuantity').Value := 0;
            Parameters.ParamByName('@NewQuantity').Value := spEQScripViewQuantity.Value;
...
procedure TfrmEQBatchScrip.actDetachScripExecute(Sender: TObject);
var
    BatchID: Int64;
    TmpDealID: Int64;
begin
    ...
    begin
        ...
        TmpDealID := spEQGetDealScripsDealID.Value;
    end else if CAID <> 0 then
    begin
        SelectScrip(spEQGetCorporateActionScripsID.Value);
        //CAID := spEQGetCorporateActionScripsCorporateActionID.Value;
    end;
    ...
    begin
        ...
        begin
            ...
            Parameters.ParamByName('@NewQuantity').Value := -(spEQScripViewQuantity.Value);
            Parameters.ParamByName('@CorporateActionID').Value := CAID;
            Parameters.ParamByName('@CorporateActionType').Value := spEQSCripCorporateActionDetailsCorporateActionType.Value;
            Parameters.ParamByName('@Direction').Value := spEQSCripCorporateActionDetailsDirection.Value;
            Prepared := True;
            ExecProc;
        end;
    end;
...
procedure TfrmEQBatchScrip.actAttachScripUpdate(Sender: TObject);
begin
    TAction(Sender).Enabled :=
        (spEQScripView.Active and (spEQScripView.RecordCount > 0)) and
        (((spEQBatchDetails.Active) and
        ...
        (spEQSCripCorporateActionDetailsUnScriped.Value > 0) and
        (spEQSCripCorporateActionDetailsDirection.value = 'Outgoing')));
end;

procedure TfrmEQBatchScrip.actDetachScripUpdate(Sender: TObject);
begin
    TAction(Sender).Enabled :=
        (((spEQBatchDetails.Active) and
        (spEQBatchDetails.RecordCount > 0) and
...
procedure TfrmEQBatchScrip.actSelectScripUpdate(Sender: TObject);
begin
    TAction(Sender).Enabled :=
        (((spEQBatchDetails.Active) and
        (spEQBatchDetails.RecordCount > 0) and
...
procedure TfrmEQBatchScrip.CustomiseGrid1Click(Sender: TObject);
begin
...
procedure TfrmEQBatchScrip.actPrintLetterToBrokerExecute(Sender: TObject);
begin
...
procedure TfrmEQBatchScrip.actPrintLetterToClientExecute(Sender: TObject);
begin
    with frmQuickReports do
        begin
...
procedure TfrmEQBatchScrip.chkAllocateToClientClick(Sender: TObject);
begin
    lkpClient.Enabled := chkAllocateToClient.Checked;
end;

procedure TfrmEQBatchScrip.chkDiffCounterClick(Sender: TObject);
begin
...
procedure TfrmEQBatchScrip.tblCounterAfterScroll(DataSet: TDataSet);
begin
        lkpTransferSecretary.EditValue := tblCounterTransferSecretaryID.Value;
end;

procedure TfrmEQBatchScrip.spEQGetDealScripsAfterScroll(DataSet: TDataSet);
begin
     SelectScrip(spEQGetDealScripsID.Value);
      chkAllocateToClient.Checked := (not spEQScripViewCounterpartyID.IsNull);
...
procedure TfrmEQBatchScrip.EnableEditing(bEnable : Boolean);
begin
...
procedure TfrmEQBatchScrip.spEQGetCorporateActionScripsAfterScroll(
  DataSet: TDataSet);
begin
     SelectScrip(spEQGetCorporateActionScripsID.Value);
     chkAllocateToClient.Checked := (not spEQScripViewCounterpartyID.IsNull);
